      ...
      try {
        ...
        if (response.data) {
          ...
          if (appState.user.username != response.data.author.username) {
            appDispatch({ type: "flashMesseges", value: "you do not have permission" });
            props.history.push("/");
          }
        } else {
        ...
        console.log("error from edit post page review");
      }
    };
    getPost();
    return () => {
    ...
    if (state.sendCount) {
      ...
      const updatePost = async function () {
        try {
          ...
          appDispatch({ type: "flashMesseges", value: "post was updated" });
        } catch (error) {
          console.log("error from edit post submit");
        }
      };
      updatePost();
      return () => {
  ...
  return (
    <Page title="Edit Post">
      ...
      <form onSubmit={submitHandler} className="mt-3">
        ...
        <button className="btn btn-primary" disbled={state.isSaving}>
